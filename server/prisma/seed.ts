  ...
  await prisma.$transaction(async (tx) => {
    const profile = await tx.profile.create({
      data: {
        ...
        linkedinUrl: 'https://www.linkedin.com/in/adee-imah/',
      ...
      data: [
        {
          ...
          thumbnail: '/images/saving-goals-thumbnail.png',
        ...
        },
        {
          ...
          thumbnail: '/images/partnership-thumbnail.jpg',
          projectType: 'Personal Project',
          status: 'COMPLETED',
        ...
        },
        {
          ...
          thumbnail: '/images/belanja-cepat-thumbnail.png',
        ...
        },
        {
          ...
          thumbnail: '/images/student-market-thumbnail.png',
          projectType: 'Group Project',
          status: 'COMPLETED',
          techStack: ['Figma', 'Microsoft Office', 'Google Forms'],
          githubUrl: null,
