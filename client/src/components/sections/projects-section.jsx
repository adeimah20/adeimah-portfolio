    ...
    <section id="projects" className="py-24 lg:py-32 bg-obsidian border-b border-obsidian-border/50 relative overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {loading ? (
            <div className="col-span-1 md:col-span-2 flex flex-col items-center justify-center py-16 gap-2 text-neutral-500 font-mono text-xs">
              <span className="w-4 h-4 border-2 border-glow-cyan border-t-transparent rounded-full animate-spin" />
              <span>Loading projects...</span>
            </div>
          ) : error ? (
            <div className="col-span-1 md:col-span-2 flex items-center justify-center py-16 text-red-500 font-mono text-xs">
